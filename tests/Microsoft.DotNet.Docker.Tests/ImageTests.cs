...
namespace Microsoft.DotNet.Docker.Tests
{
    public class ImageTests
    {
        ...
        private static readonly ImageData[] s_windowsTestData =
        {
            ...
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.NanoServerLtsc2019 },
            ...
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.NanoServerLtsc2019, IsWeb = true },
            ...
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.NanoServerLtsc2019 },
            ...
            new ImageData { DotNetVersion = "2.2", OsVariant = OS.NanoServerLtsc2019, IsWeb = true },
            ...
            new ImageData { DotNetVersion = "3.0", OsVariant = OS.NanoServerLtsc2019 },
            ...
            new ImageData { DotNetVersion = "3.0", OsVariant = OS.NanoServerLtsc2019, IsWeb = true },
        };
        ...
        private async Task VerifyRuntimeImage_FrameworkDependentApp(ImageData imageData, string appSdkImage)
        {
            ...
            bool isRunAsContainerAdministrator = 
                ...
                || String.Equals(OS.NanoServerLtsc2019, imageData.OsVariant, StringComparison.OrdinalIgnoreCase);
