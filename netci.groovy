...
def platformList = [
        ...
        //'Windows_2016:NanoServer-ltsc2019'
    ]
...
platformList.each { platform ->
    ...
    if (containerOS == 'NanoServer-1709' || containerOS == 'NanoServer-1803' || containerOS == 'NanoServer-ltsc2019') {
    ...
    versionList.each { version ->
        ...
        else if (containerOS == 'NanoServer-ltsc2019') {
